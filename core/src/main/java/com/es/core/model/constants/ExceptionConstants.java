...
public class ExceptionConstants {
    public static final int MAX_PHONES_IN_CART = 5;
    public static final String DATABASE_SAVE_PROBLEM = "Problem saving data into database";
    public static final String DATABASE_PROBLEM = "Problems with database. Can't get information from database";
