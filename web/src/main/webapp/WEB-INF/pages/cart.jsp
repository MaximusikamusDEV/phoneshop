...
<form:form method="post" modelAttribute="cartDto" action="/phoneshop-web/cart/updateCart">
        ...
        <c:forEach var="cartItem" items="${cart.cartItems}" varStatus="i">
            <tr>
                ...
                <td class="text-center align-middle" style="width: 1%; height: 1%; white-space: nowrap;">
                    <button type="submit" name="deletePhoneId" value="${cartItem.phone.id}" class="btn btn-primary">Delete</button>
                </td>
